...
class FAT32:
    def __init__(self, starting_offset, drive)->None:
        ...
        self.DIR_Attr = '' #1 byte
        self.DIR_CrtTimeTenth = 0 #1 byte
        self.DIR_CrtTime = 0 #2 bytes
        self.DIR_CrtDate = 0 #2 bytes
        self.DIR_LstAccDate = 0 #2 bytes
        self.DIR_FstClusHI = 0 #2 bytes
        self.DIR_WrtTime = 0 #2 bytes
        self.DIR_WrtDate = 0 #2 bytes
        self.DIR_FstClusLO = 0 #2 bytes
